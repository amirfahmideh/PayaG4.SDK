...
public class PayslipDesignService : BaseService
{
    ...
    private readonly string apiPrefix = "/api/v1/payslipDesign/";
    public PayslipDesignService(ServiceConfiguration _serviceConfiguration) : base(_serviceConfiguration)
    {
        httpClient = new HttpClient();
        httpClient.Timeout = Timeout.InfiniteTimeSpan;
    }
    public async Task<MethodResult<GridData<PayslipDesignDTO>>> GetAllValidListPayslipDesign()
    {
        try
        {
